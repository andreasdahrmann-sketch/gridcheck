...
console.log(`✅ Skill geladen: ${skill.name} (${skill.content.length} chars)`);
console.log(`✅ Rules geladen: v${rules.version}, ${rules.rules.length} Regeln\n`);

const validator = new InputValidator(rules);

// Test 1: Gültiger Input
console.log('--- Test 1: Gültiger Input ---');
