...
def handle_stripe_webhook(db: Session, payload: bytes, stripe_signature: str | None) -> dict[str, str]:
    ...
    # antworten wir mit 200, damit Stripe nicht in einen Retry-Loop faellt.
    # Kein DB-Write: diese Route ist unauthentifiziert und waere sonst eine
    # Write-Amplification-Flaeche, solange das Billing bewusst deaktiviert ist.
