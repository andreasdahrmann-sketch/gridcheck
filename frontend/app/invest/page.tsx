...
import { ArrowRight, BarChart3, ShieldAlert, WalletCards } from "lucide-react";
  ...
  return (
    <main className="min-h-screen bg-bg text-white">
          ...
          <div className="grid gap-6 xl:grid-cols-[minmax(0,1.15fr)_minmax(320px,0.85fr)] xl:items-start">
            <div>
              ...
              <h1 className="mt-5 max-w-4xl text-4xl font-semibold tracking-tight text-white sm:text-5xl">
                Invest-Modul fuer Standortbewertung, Risikoanalyse und Kostenbandbreite.
              </h1>
              <p className="mt-4 max-w-3xl text-base leading-7 text-text-muted sm:text-lg sm:leading-8">
                Der aktive Invest-Pfad verdichtet Standortqualitaet, N-1- und Trassenrisiken, Kostenbandbreiten,
                Due-Diligence-Hinweise und investorentaugliche Ergebnisdarstellung.
              </p>
              <div className="mt-6 flex flex-col gap-3 sm:flex-row">
                ...
                >
                  Strategische Anschlussdarstellung anfragen
                </Link>
              </div>
            </div>

            <div className="rounded-[28px] border border-white/10 bg-white/5 p-5 shadow-[0_20px_60px_rgba(0,0,0,0.24)]">
              <p className="text-xs font-medium uppercase tracking-[0.22em] text-brand-cyan">Invest MVP Scope</p>
              <div className="mt-4 space-y-3">
                {[
                  {
                    title: "Standort- und Risikobewertung",
                    description: "Standortpraezisierung, Netz-/Trassen-/Genehmigungsrisiken und Stakeholder-Fit werden verdichtet.",
                    icon: BarChart3,
                  },
                  {
                    title: "Due-Diligence-orientierte Ausgabe",
                    description: "Kostenbandbreite, Audit-Hash, Datenbasis und naechste Pruefschritte bleiben investorentauglich lesbar.",
                    icon: WalletCards,
                  },
                ].map((item) => (
              ...
              <div className="mt-4 rounded-2xl border border-brand-orange/20 bg-brand-orange/10 px-4 py-4 text-sm leading-6 text-text-muted">
                <p className="flex items-center gap-2 font-medium text-white">
                  ...
                  Keine internen Netzdaten im Investpfad
                </p>
                <p className="mt-2">
                  Die Investsicht zeigt bewusst aggregierte Risiko-, Kosten- und Prozessindikatoren. Rohe Feeder-,
                  Impedanz- oder interne Netzkapazitaetsdaten bleiben ausgeblendet.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="mx-auto max-w-6xl px-4 py-6 sm:px-6 sm:py-8">
        <GridCheckForm forcedCustomerType="investor" />
      </section>
    </main>
  );
}
